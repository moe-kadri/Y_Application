...
public class SocialMediaApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Event handlers
        searchButton.setOnAction(e -> searchPosts(searchField.getText(), postsContainer));
    ...
    private void showCommentDialog(String postText) {
        ...
        commentContainer.setMaxHeight(300); // Adjust the value based on your preference
        ...
        addCommentButton.setOnAction(e -> {
            if (!commentField.getText().isEmpty()) {
                ...
                VBox singleCommentContainer = createCommentContainer("Adam", "2020", commentField.getText());
        ...
        scrollPane.setPrefSize(400, 200); // Adjust the values based on your preference
    ...
    private VBox createCommentContainer(String author, String date, String commentText) {
